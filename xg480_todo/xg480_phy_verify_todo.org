...
** STARTED The rate_meter_multiple issues [33%]
...
*** STARTED tc_209 Line side mac_tx port shaper function (by rate_meter_multiple module) test.[%]
   :LOGBOOK:  
   CLOCK: [2018-07-09 Mon 15:51]--[2018-07-09 Mon 16:11] =>  0:20
   :END:      
**** STARTED SYS side DRIVER/MONITOR don't respond BP, DUT segbuf will overflow, DUT should not send out the fragment of packet.
    :LOGBOOK:  
...
** STARTED sys side traffic packet with ITMH/OTMH [66%]
   :LOGBOOK:  
...
*** STARTED the eth_object_parser need parser OTMH.
    :LOGBOOK:  
