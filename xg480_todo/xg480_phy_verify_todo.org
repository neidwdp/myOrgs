...
*** DONE ge104 TB and TB_ENV with PCIE interface.
    CLOSED: [2018-11-30 Fri 16:13]
    - State "DONE"       from "TODO"       [2018-11-30 Fri 16:13]
*** DONE east bulk input error packet (FCS error,  no eop, pcs error)
    CLOSED: [2018-12-03 Mon 11:09]
...
when DUT receive error packet, it will counter to receive error, and do nothing, send out. it's expected. it has been confirmed with Haidong.
