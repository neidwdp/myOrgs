* xg480_phy 25g/10g verification todo [66%]
** STARTED The rate_meter_multiple issues [100%]
...
**** TODO rate_meter_rx trigger mac_tx gen pause has bug, the interval of ON type pause is so closed. it's 200us, the expect value is 2ms.
*** DONE tc_209 Line side mac_tx port shaper function (by rate_meter_multiple module) test.[50%]
    CLOSED: [2018-07-09 Mon 18:08]
...
**** DONE SYS side DRIVER/MONITOR don't respond BP, DUT segbuf will overflow, DUT should not send out the fragment of packet.
    ...
    :END:      
    tc_209
***** TODO port shaper didn't gen rate Exceed out, egress input traffic 25G, port shaper set 10G. need Tonny double check.
**** TODO make SYS side DRIVER/MONITOR respond BP, if shaper set 15G, input 25G, if driver receive the BP, driver will adapt the 15G 
...
**** TODO SFP reserve pin, out pin test fail, need Haidong double check. tc_1001
...
*** DONE normal traffic with loopback traffic. to test arbitration [66%]
...
**** DONE normal traffic with termail loopback tc_310 (100G mode) tc_312 (25G mode)
     ...
     :END:      
**** STARTED re-run TCs when desinger fixing bug. (The bug: arbitration cannot always correctly work when normal traffic and lpbk traffic are valid in the same time.)
     :LOGBOOK:  
...
*** DONE update the cmac lbus monitor, if rx_rdy is 0 and sop has been valid, max allow 4.
    ...
    :END:      
** STARTED all control register test [%]
   tc_1002.
...
*** DONE 25G device 25G mode, random disable/enable NGMII interface.
    CLOSED: [2018-07-03 Tue 15:46]
    - State "DONE"       from "TODO"       [2018-07-03 Tue 15:46]
    tc_004a.
**** TODO more times disable/enable ngmii, DUT output fragment of packet, it should not; Waiting Tonny to doulbe check and fixed it.
*** DONE 25G device 10G mode, random disable/enable NGMII interface.
    CLOSED: [2018-07-03 Tue 16:06]
    - State "DONE"       from "TODO"       [2018-07-03 Tue 16:06]
    tc_003a
*** DONE 25G device 100G mode, random disable/enable CGMII interface.
    ...
    tc_006l
*** DONE 25G device 100G mode, random disable/enable LBUS interface.
    CLOSED: [2018-07-03 Tue 15:58]
    - State "DONE"       from "TODO"       [2018-07-03 Tue 15:58]
    Need DUT (LBUS) support register prov interface disable/enable
    tc_006l
** TODO 10G 25G 100G interface if support the LPI [%]
** STARTED sys side traffic packet with ITMH/OTMH [60%]
   :LOGBOOK:  
...
*** TODO CGMII IF ADVA HDR test
*** TODO NGMII IF ADVA HDR test
** STARTED Help Atlanta Mike check the T_dcn_switch_v1.0_r112857 regression results [0%]
   DEADLINE: <2018-07-12 Thu>
   :LOGBOOK:  
   CLOCK: [2018-07-09 Mon 14:22]--[2018-07-09 Mon 14:47] =>  0:25
   :END:      
*** STARTED dcn_switch tc_009 checking, ATL 13 errors, SZX no errors
...
*** TODO dcn_switch tc_009a checking, ATL 57011 errors, SZX ?
    SCHEDULED: <2018-07-09 Mon>
*** TODO dcn_switch tc_017b checking, ATL 7 errors, SZX ?
    SCHEDULED: <2018-07-09 Mon>
*** TODO dch_switch tc_018 checking, ATL 550 errors, SZX ?
    SCHEDULED: <2018-07-10 Tue>
*** TODO dcn_switch tc_020 checking, ATL 60 errors, SZX ?
    SCHEDULED: <2018-07-10 Tue>
*** TODO dcn_switch tc_021 checking, ATL 23 errors, SZX no errors.
    SCHEDULED: <2018-07-11 Wed>
*** TODO dcn_switch tc_022 checking, ATL 5 errors, SZX no errors.
    SCHEDULED: <2018-07-11 Wed>
