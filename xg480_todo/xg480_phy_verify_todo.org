* xg480_phy 25g/10g verification todo [61%]
...
** TODO Lbus frame interface test for 100G mode.[66%]
*** STARTED 64 to 129 bytes size packet, each type size 200us
    :LOGBOOK:  
